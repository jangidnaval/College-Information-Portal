...
<html>
	...
	<body>
		...
		<?php 
			...
			$query="SELECT * FROM faculty U where U.fid='$id' ";
			...
			else
			{
				...
				$res=$con->query("INSERT INTO user (id,password,type) VALUES ('$id','$password','faculty' )");	
				$res1=$con->query("INSERT INTO faculty (fid,first_name,last_name,email,did,dob) VALUES ('$id','$first_name','$last_name','$email','$branch','$DOB')" );
